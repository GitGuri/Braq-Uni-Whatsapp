...
const BOT_STATES = new Set([
  'new', 'main_menu', 'retail_menu', 'retail_pricing', 'retail_school_info',
  'retail_hours', 'retail_layby', 'retail_collection', 'corporate_menu',
  'corporate_new_order', 'corporate_repeat_order', 'quotation_requested',
])
...
const STATE_LABELS = {
  ...
  corporate_po_quotation_ref:  'Bot — PO ref',
  corporate_po_number:         'Bot — PO number',
  corporate_design_approval:   'Bot — Design approval',
  ticket_category:             'Bot — Ticket category',
  ticket_description:          'Bot — Ticket description',
  registration_name:           'Bot — Registration (name)',
  registration_org_or_school:  'Bot — Registration (org)',
